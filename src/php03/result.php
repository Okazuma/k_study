                ...
                <div class="result-cards">
                    ...
                    <div class="result-card">
                        <div class="result-card__img-wrapper">
                            <img class="result-card__img" src="img/<?php echo $tokyo['img']?>" alt="国籍">
                        </div>
                    ...
                    <div class="result-card">
                        <div class="result-card__img-wrapper">
                            <img class="result-card__img" src="img/<?php echo $another['img']?>" alt="国籍">
                        </div>
                        <div class="result-card__body">
                            <p class="result-card__city"><?php echo $another["name"]?></p>
                            <p class="result-card__time"><?php echo $another["time"]?></p>
                        </div>
                    </div>
                </div>
            </div>
